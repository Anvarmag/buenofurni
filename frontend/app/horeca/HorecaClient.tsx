            ...
            <section className="py-24 md:py-32 bg-[var(--background)] text-center">
                <div className="container max-w-4xl mx-auto flex flex-col items-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                        ...
                        <a href="https://t.me/buenofurni_support" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto button-secondary h-16 px-8 text-lg font-bold flex items-center justify-center gap-3 bg-white">
